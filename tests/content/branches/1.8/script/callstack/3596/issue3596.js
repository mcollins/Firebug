    ...
    FBTest.openNewTab(basePath + "script/callstack/3596/issue3596.html", function(win)
    {
        ...
        FBTest.enableScriptPanel(function(win)
        {
            ...
            FBTest.waitForBreakInDebugger(FW.Firebug.chrome, 18, false, function(row)
            {
                ...
                FBTest.ok(FW.FBL.hasClass(frames[1], "hasTwisty"), "The second frame must be expandable");
                FBTest.ok(FW.FBL.hasClass(frames[3], "hasTwisty"), "The fourth frame must be expandable");
                ...
                FBTest.ok(FW.FBL.hasClass(frames[1], "hasTwisty.opened"), "The second frame must be expanded");
