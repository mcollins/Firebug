function runTest()
{
    ...
    FBTestFirebug.openNewTab(basePath + "inspector/Issue68FrameExpected.htm", function(win)
    {
        ...
        FBTestFirebug.openURL(basePath + "inspector/Issue68FrameActual.htm", function(win)
        {
