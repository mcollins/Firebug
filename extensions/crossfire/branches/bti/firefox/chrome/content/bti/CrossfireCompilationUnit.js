...
define("CrossfireCompilationUnit", [], function(){
 ...
 * @type CrossfireCompilationUnit
 * @return a new CrossfireCompilationUnit
 * @version 1.0
 */
function CrossfireCompilationUnit(url, context, crossfireClient)
{
    this.url = url;
    this.context = context;
    this.breakpoints = [];
    this.numberOfLines = 0;
    this.kind = CrossfireCompilationUnit.SCRIPT_TAG;
 ...
 */
CrossfireCompilationUnit.SCRIPT_TAG = "script_tag";
CrossfireCompilationUnit.EVAL = "eval";
CrossfireCompilationUnit.BROWSER_GENERATED = "event";
 ...
 * </p>
 */
CrossfireCompilationUnit.prototype.getKind = function getKind()
{
    return this.kind;
}

CrossfireCompilationUnit.prototype.isExecutableLine = function isExecutableLine(lineNo)
{
    return false; //xxxMCollins crossfire hack
}
 ...
 */
CrossfireCompilationUnit.prototype.getURL = function()
{
    return this.url;
};
 ...
 */
CrossfireCompilationUnit.prototype.getBrowserContext = function()
{
    return this.context;
};
 ...
 */
CrossfireCompilationUnit.prototype.getBreakpoints = function()
{
...
CrossfireCompilationUnit.prototype.eachBreakpoint = function( fnOfLineProps )
{
 ...
 * @param listener a listener (function) that accepts (CrossfireCompilationUnit, firstLineNumber, lastLineNumber, array of source code lines)
 */
CrossfireCompilationUnit.prototype.getSourceLines = function(firstLine, lastLine, listener)
{
    ...
    //FIXME: need to add response listeners.
...
/**
 * Request the current estimated number of source lines in the entire CrossfireCompilationUnit
 */
CrossfireCompilationUnit.prototype.getNumberOfLines = function()
{
 ...
 * @function
 */
CrossfireCompilationUnit.prototype._addBreakpoint = function(breakpoint)
{
 ...
 * @function
 */
CrossfireCompilationUnit.prototype._removeBreakpoint = function(breakpoint)
{
    for ( var i = 0; i < this.breakpoints.length; i++)
    {
...
return CrossfireCompilationUnit;
