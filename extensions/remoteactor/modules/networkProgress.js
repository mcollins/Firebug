...
var EXPORTED_SYMBOLS = ["NetworkProgress"];
...
try
{
    ...
    Components.utils["import"]("resource://remoteactor/networkMonitor.js");
}
catch (err)
{
...
NetworkProgress.prototype =
{
    initialize: function(win, callback)
    {
        ...
        this.networkMonitor.register(this.win, Lib.bind(this.onNetworkEvent, this));
    },
    ...
    flush: function()
    {
        ...
        var onFlush = Lib.bind(this.onFlush, this);
    ...
    getRequestFile: function(request)
    {
        ...
        var file = {
            ...
            href: safeGetRequestName(request),
        };
