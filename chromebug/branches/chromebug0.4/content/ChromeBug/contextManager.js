...
*/
    ...
    watchLoadedTopWindow: function(win)
    {
        ...
        if (context && !context.loaded)
        {
            context.loaded = true;
            if (FBTrace.DBG_WINDOWS)                                                                                   /*@explore*/
                FBTrace.sysout("contextManager ***************> Context loaded in tabWatcher.watchLoadedTopWindow\n");                /*@explore*/
    ...
    watchWindow: function(win, context)
    {
        ...
        if (FBTrace.DBG_WINDOWS) {                                                                                     /*@explore*/
            ...
            if (context)                                                                                               /*@explore*/
                for (var i = 0; i < context.windows.length; i++)                                                       /*@explore*/
                    FBTrace.sysout("contextManager watchWindow context("+context.uid+").windows["+i+"]= ("                            /*@explore*/
        ...
        if (context && context.windows.indexOf(win) == -1 && href != aboutBlank)
        {
            ...
            if (FBTrace.DBG_WINDOWS)                                                                                   /*@explore*/
                FBTrace.sysout("contextManager watchWindow sets context for href="+href+"\n");                                        /*@explore*/
                                                                                                                       /*@explore*/
