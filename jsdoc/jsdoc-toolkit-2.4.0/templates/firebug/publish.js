...
function shouldDisplayMemberOf(member)
{
  return member.isStatic && !member.isScope && member.memberOf != '_global_';
}
...
JSDOC.JsPlate.scope.shouldDisplayMemberOf = shouldDisplayMemberOf;